// File path: /components/applications/application-form.tsx
// Optimized version of ApplicationForm
...
const formSchema = z.object({
  ...
  type: z.string({ required_error: "Please select a job type" }),
...
export function ApplicationForm({ defaultValues = {}, isEditing = false }) {
  ...
  const form = useForm({
    ...
    defaultValues: {
      company: "", position: "", location: "", type: "", salary: "",
      applicationDate: new Date(), url: "", status: "Applied",
      contactName: "", contactEmail: "", contactPhone: "", notes: "", ...defaultValues
    },
  })
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FormSection
          ...
          description="Enter information about the company and position you're applying for"
        >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <FormField
              control={form.control} name="salary"
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Salary Range</FormLabel>
                  <FormControl><Input placeholder="$80,000 - $100,000" {...field} /></FormControl>
                  <FormDescription>Optional: The salary range for this position</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="https://example.com/job" {...field} /></FormControl>
                  <FormDescription>Optional: Link to the job posting</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
        ...
        <FormSection
          ...
          description="Track your application status and important dates"
        >
          <div className="grid gap-4 md:grid-cols-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <FormDescription>The date you submitted your application</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>The current status of your application</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
          ...
          <div>
            ...
            <Button variant="outline" type="button">Add Attachment</Button>
          </div>
        ...
        <FormSection
          ...
          description="Information about your contact at the company"
        >
          <div className="grid gap-4 md:grid-cols-3">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Optional: The name of your contact</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Optional: Your contact's email</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              control={form.control} name="contactPhone"
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Contact Phone</FormLabel>
                  <FormControl><Input placeholder="(123) 456-7890" {...field} /></FormControl>
                  <FormDescription>Optional: Your contact's phone number</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
